...
// ToolCall is the parsed result of a model-emitted <|tool_call> block.
// Defined locally rather than reused from yzma's pkg/message because the
// litertlm-go example deliberately keeps its dependency surface to the
// litertlm package alone.
